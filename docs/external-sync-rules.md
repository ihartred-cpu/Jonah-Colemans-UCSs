...
**folded in outright** as new content, in its own file, when something like that shows up. It doesn't need
re-verification against Jonah Coleman's scripts specifically to be worth having; it just needs to be clearly
sourced and clearly distinguished from anything this pack's own docs claim empirically.
